...
class TestSolution(unittest.TestCase):
    def setUp(self) -> None:
        ...
        node2 = HyperpathNode("2", ["A3", "C5", "A1", "B1"], parent=node1)
        node1.next = node2
        node3 = HyperpathNode("3", ["A3", "C5", "A1", "C2"], parent=node2)
        node2.next = node3
        node4 = HyperpathNode("4", ["B5", "C5", "A1", "C2"], parent=node3)
        node3.next = node4
        node5 = HyperpathNode("5", ["B5", "C5", "B2", "C2"], parent=node4)
        node4.next = node5
    ...
    def test_solution_decode_path(self):
        for cur in self.solution.hyperpath:
            cur_node = cur.quadruple
